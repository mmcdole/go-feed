...
func (ap *Parser) ParseWithOptions(feed io.Reader, options config.ParseOptions) (*Feed, error) {
	...
	return ap.parseRoot(p, options)
}

func (ap *Parser) Parse(feed io.Reader) (*Feed, error) {
	return ap.ParseWithOptions(feed, config.NewParseOptions())
}

func (ap *Parser) ParseString(feed string) (*Feed, error) {
	return ap.ParseStringWithOptions(feed, config.NewParseOptions())
}

// ParseString parses an xml feed into an interface{} of atom.Feed
func (ap *Parser) ParseStringWithOptions(feed string, options config.ParseOptions) (*Feed, error) {
	return ap.ParseWithOptions(strings.NewReader(feed), options)
}

func (ap *Parser) ParseURL(feedURL string) (*Feed, error) {
	return ap.ParseURLWithOptions(feedURL, config.NewParseOptions(), config.NewRequestOptions())
}

func (ap *Parser) ParseURLWithOptions(feedURL string, parseOptions config.ParseOptions, reqOptions config.RequestOptions) (*Feed, error) {
	...
	return ap.ParseWithOptions(body, parseOptions)
}

func (ap *Parser) parseRoot(p *xpp.XMLPullParser, o config.ParseOptions) (*Feed, error) {
