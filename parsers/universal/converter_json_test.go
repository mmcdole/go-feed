...
func TestDefaultJSONConverter_Convert(t *testing.T) {
	...
	for _, f := range files {
		...
		actual, _ := translator.Convert(jsonFeed)
...
func TestDefaultJSONConverter_Convert(t *testing.T) {
	...
	actual, _ := translator.Convert(feed)
...
func TestDefaultJSONConverter_Convert_WrongType(t *testing.T) {
	translator := &DefaultJSONConverter{}
