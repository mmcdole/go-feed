...
func (rp *Parser) ParseWithOptions(feed io.Reader, options config.ParseOptions) (*Feed, error) {
...
func (rp *Parser) Parse(feed io.Reader) (*Feed, error) {
	return rp.ParseWithOptions(feed, config.NewParseOptions())
}

func (rp *Parser) ParseString(feed string) (*Feed, error) {
	return rp.ParseStringWithOptions(feed, config.NewParseOptions())
}

func (rp *Parser) ParseStringWithOptions(feed string, options config.ParseOptions) (*Feed, error) {
	return rp.ParseWithOptions(strings.NewReader(feed), options)
}

func (rp *Parser) ParseURL(feedURL string) (*Feed, error) {
	return rp.ParseURLWithOptions(feedURL, config.NewParseOptions(), config.NewRequestOptions())
}

func (rp *Parser) ParseURLWithOptions(feedURL string, parseOptions config.ParseOptions, reqOptions config.RequestOptions) (*Feed, error) {
	...
	return rp.ParseWithOptions(body, parseOptions)
}
